        ...
        <>
            <div className="container max-w-5xl mx-auto m-8">
                ...
                <div className="flex flex-wrap flex-col-reverse sm:flex-row">
                    <div className="w-full sm:w-1/2 p-6 mt-6">
                        <img className="rounded-lg hover:scale-105 cursor-pointer transition-all duration-150 ease-out w-full md:w-4/5 z-50" src="https://w7.pngwing.com/pngs/1008/377/png-transparent-computer-icons-avatar-user-profile-avatar-heroes-black-hair-computer.png" />
                    </div>
