...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`transition-all ${router.pathname==='/map'?'bg-green-300':'bg-transparent'} ease-out duration-700 fixed top-0  w-screen  z-10 md:z-50 px-4 flex h-14  items-center justify-between md:justify-start lg:justify-between py-8 pb-10`}
      >
      {/* <div
